...
public class GameServerListener extends Thread 
{
	...
	public volatile HandlerUpdate h;
...
//							KeyBoard key = new KeyBoard();
							...
							for(int i=0; i<playerList.size(); i++)
							{
								...
								if(playerList.get(i).getPlayerNo() == 1)
								{
									System.out.println("SERVER SIDE: SET SPAWN POINT FOR PLAYER 1");
									playerList.get(i).setX(16);
									playerList.get(i).setY(16);
								}
								if(playerList.get(i).getPlayerNo() == 2)
								{
									System.out.println("SET SPAWN POINT FOR PLAYER 2");

									playerList.get(i).setX(23*16);
									playerList.get(i).setY(16);
								}
								if(playerList.get(i).getPlayerNo() == 3)
								{
									System.out.println("SET SPAWN POINT FOR PLAYER 3");

									playerList.get(i).setX(16);
									playerList.get(i).setY(10*16);
								}
								if(playerList.get(i).getPlayerNo() == 4)
								{
									System.out.println("SET SPAWN POINT FOR PLAYER 4");
									playerList.get(i).setX(23*16);
									playerList.get(i).setY(10*16);
								}
